    ...
    .map((item) => {
      ...
      return `
        <div class="notification-item" data-notif-id="${item.id || ""}">
          <button class="notification-close" data-notif-id="${item.id || ""}" data-notif-path="${notificationPath}" onclick="removeNotification(this.getAttribute('data-notif-id'), this.getAttribute('data-notif-path'))">Delete</button>
