...
function openModal({ type, title, message, detail, confirmText, cancelText, onConfirm, onCancel, asyncAction }) {
  if (!title || !message) {
...
function showConfirmModal(options) {
  const { title, message, confirmText, cancelText, onConfirm, onCancel, asyncAction } = options;
  return openModal({
    type: 'confirm',
    title,
    message,
